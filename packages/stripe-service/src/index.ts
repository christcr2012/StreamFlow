...
export class StripeService {
   ...
   */
  async createCustomer(data: CreateCustomerInput): Promise<{ id: string; [key: string]: any }> {
   ...
   */
  async createPaymentIntent(data: CreatePaymentIntentInput): Promise<{ id: string; client_secret: string; [key: string]: any }> {
   ...
   */
  async getCustomer(customerId: string): Promise<{ id: string; [key: string]: any }> {
