 ...
 */
export function getTenantSession(request: NextRequest): TenantSession | null {
  const cookies = request.cookies;
 ...
 */
export function getAccountantSession(request: NextRequest): TenantSession | null {
  const cookies = request.cookies;
 ...
 */
export function getVendorSession(request: NextRequest): TenantSession | null {
  const cookies = request.cookies;
