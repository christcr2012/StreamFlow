...
export default async function handler(
  ...
  try {
    ...
    // NOTE: SHA-1 is used here intentionally because it's the protocol required by HaveIBeenPwned API
    // This is NOT for password storage - we're checking if a password exists in breach databases
    // The k-anonymity approach (only sending first 5 chars) protects the actual password
