...
import { useOfflineTimeClockSafe } from "@/lib/hooks/useOfflineTimeClockSafe";
 ...
 * Codex Phase 5: Now uses offline-first time clock hook with SSR-safe lazy loading
 */
function WorkerClock() {
  ...
  // Codex Phase 5: Use SSR-safe offline-first time clock hook
  const {
    currentSession,
    isClocked,
    sessionDuration,
    ...
    formatDuration,
    error: clockError,
  } = useOfflineTimeClockSafe({ enableLocationTracking: true, autoSync: true });
