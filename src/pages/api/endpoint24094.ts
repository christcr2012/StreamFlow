...
// Schema for POST /api/v4/endpoint24094
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // 
    // - **Method**: POST
    // - **Path**: /api/v4/endpoint24094
    // - **Headers**: X-Idempotency-Key: ik-24094
    // - **Request**:
    // ```json
    // {"tenant_id": "T001", "request_id": "req-24094", "actor": {"user_id": "U1", "role": "tenant_manager"}, "payload": {"field": 24094, "op": "upsert", "value": "V24094"}, "idempotency_key": "ik-24094"}
    // ```
    // - **Response**:
    // ```json
