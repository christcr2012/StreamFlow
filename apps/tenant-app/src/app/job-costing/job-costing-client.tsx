    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            return (
              <div key={job.id} className="bg-white rounded-lg border p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span
                    className={`px-3 py-1 text-sm font-semibold rounded-full ${job.profitMargin > 30 ? "bg-green-100 text-green-800" : job.profitMargin > 15 ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"}`}
                  >
                    {job.profitMargin.toFixed(1)}% margin
                  </span>
                </div>
        ...
        {/* PHASE 2: Stub implementation (blocked by dependencies)
            Blocked by:
            - [prisma_model] JobCost
            - [prisma_model] Job
            - [feature] costing engine (cost aggregation + variance)
            - [feature] budget alerts/thresholds
        */}
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <p>
                Uses placeholder data. Blocked by JobCost/Job models and a
                costing engine to compute real
                labor/materials/equipment/overhead, plus budget alerts.
              </p>
            </div>
          </div>
        </div>
